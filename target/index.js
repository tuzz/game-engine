...
function init(module) {
    ...
    imports.wbg.__widl_f_fetch_with_str_Window = function(arg0, arg1, arg2) {
        const ret = getObject(arg0).fetch(getStringFromWasm(arg1, arg2));
        return addHeapObject(ret);
    };
    ...
    imports.wbg.__widl_f_set_src_HTMLImageElement = function(arg0, arg1, arg2) {
        getObject(arg0).src = getStringFromWasm(arg1, arg2);
    };
    ...
    imports.wbg.__wbindgen_closure_wrapper907 = function(arg0, arg1, arg2) {
        ...
        const real = (arg0) => {
            state.cnt++;
            try {
                return __wbg_elem_binding0(state.a, state.b, arg0);
            } finally {
                if (--state.cnt === 0) {
                    wasm.__wbg_function_table.get(36)(state.a, state.b);
                    state.a = 0;
                }
            }
        }
